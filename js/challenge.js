...
// 2. As a user, I can manually increment and decrement the counter using the plus and minus button
...
// 3. As a user, I can "like" an individual number of the counter. I should see the count of the
